<!-- guardrails-kit: v1.0 migrated 2026-07-05; KIT CORE+FOOTER deduped 2026-07-05 — kit rules load from ~/.claude/CLAUDE.md (global, always loaded); on-demand docs stay in this repo's docs/guardrails/ -->
